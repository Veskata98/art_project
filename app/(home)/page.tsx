...
export default async function HomePage() {
  ...
  return (
    <div className="flex flex-col px-2 sm:px-4 items-center container mx-auto mt-4 space-y-4 md:space-y-8 mb-8">
      ...
      <p className="text-lg md:text-2xl lg:text-center text-pretty md:font-semibold select-none">
      ...
      <Button asChild>
        <Link
          href="/artworks"
          className="text-lg sm:text-xl transition-shadow font-semibold bg-gradient-to-r from-[#974ef2] to-[#ff953f] shadow-gradient-shadow hover:shadow-gradient-shadow-hover text-white
          "
        >
