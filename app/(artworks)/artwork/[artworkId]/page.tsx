    ...
    return (
        <section className="relative w-full xl:w-4/6 lg:w-5/6">
            ...
            <div className="flex md:flex-row flex-col gap-6 mb-2">
                <div className="flex flex-col justify-center items-center w-full h-[400px] md:h-[600px] relative p-2">
                    <Image src={artwork.image} alt={artwork.title} className="object-contain p-2" fill />
                </div>
                <aside className="md:w-[30rem] w-full flex flex-col pt-0 md:p-4  items-center justify-around md:shadow-xl">
