...
export default function ContactPage() {
    return (
        <section className="flex h-full flex-col justify-center items-center mx-auto p-8 text-center">
            ...
            <div>
                <Link href="https://www.facebook.com" className="flex items-center flex-col">
                    ...
                    <i aria-hidden className="fa-brands fa-facebook text-4xl"></i>
                </Link>
                <Link href="https://www.instagram.com" className="flex items-center flex-col">
                    <h3 className="text-2xl mb-2 mt-8">Instagram</h3>
                    <i aria-hidden className="fa-brands fa-instagram text-4xl"></i>
                </Link>
            </div>
        </section>
    );
